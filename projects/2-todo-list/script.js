function populateTodoList(todos) {
  ...
  for (let x = 0; x < todoList.length; x++){
    ...
    listItem.classitemLi.add("list-group-item", "d-flex", "justify-content-between", "align-items-center");
...
let todos = [
  ...
  { task: "Feed the pets", completed: false},
  { task: "Play some games", completed: true},
  { task: "Help mom with the weeks food", completed: true}
];
